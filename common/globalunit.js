class Globalunit{
	constructor() {
		this.downloadurl = "https://catgame.dcloud.io/publish/index.html";
		...
		this.domainName = "https://catgame.dcloud.io/download/index.html"; //分销裂变下载页的域名
		this.appName = "萌猫成长"
		this.share = {
			title:"萌猫成长",
			summary:"萌猫成长是一款趣味合成类网赚游戏。",
			imageUrl:"https://web-assets.dcloud.net.cn/ext/moneygame/cat-logo.png"
		}
		//下载页面信息
		this.about = {
			logo:"https://web-assets.dcloud.net.cn/ext/moneygame/cat-logo.png",
			appName:"萌猫成长",
			slogan:"趣味合成类网赚游戏",
